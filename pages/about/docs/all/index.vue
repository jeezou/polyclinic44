<template>
  <div class="all-docs-page container">
    <bread-crumbs/>
    <!--    <docs-block :title="'Врачи'" :isPage="true"/>-->
    <div class="all-docs-page__title section-title">Медицинский персонал</div>
...
export default {
  ...
  components: {},
  meta: {
    crumb: 'Медицинский персонал',
  },
  data() {
    return {
      cards: [
        // {
        //   title: 'Общий список медицинских работников с образованием',
        //   link: '/docs/Общий_список_мед_работников_с_образованием.ods',
        //   img: 'cards-icons/excel.png',
        //   type: 'download',
        // },
      ],
    }
  ...
  methods: {
    async getData() {
      const res = await this.$axios.get(`${this.$store.state.posts}/247`)
